...
\date{\vspace{2mm}\footnotesize 11-February-2016 \\ {\it Bergen}\\ [2em] Aiming for  {\it Psychological Methods} \\  {\scriptsize \url{http://www.apa.org/pubs/journals/met}}}
...
to study the task of predicting academic achievements in adolescents from teacher report of inattention in childhood. \\
...
From previous reports we assume, however, that such predictions from inattention reports will be weak, given the long delay between the two time-points for data collection, but still substantial for some of the items [\textcolor{blue}{Refs ?}].\\
...
were selected according to the following criteria: ({\bf i}) the methods must handle multiple predictors jointly each having a small set of response alternatives, e.g. binary, trinary, or quaternary predictor variables, and with a small set of outcome categories, e.g. low, intermediate and high level of academic achievement; ({\bf ii}) the prediction methods should not produce results that are particularly adapted or tuned to the the sample being included, i.e. have good generalisation abilities without overfitting; 
...
The rest of the paper is organized as follows.  In the Methods section we present the Bergen Child Study this work is part of, 
...
The first wave of BCS was launched in October 2002 and included the total population of 9,430 children attending second to fourth grade (7-9 years old, born in 1993, 1994 and 1995) in all public, private, and special schools in Bergen, and 222 children from a
...
Sample protocols of the first wave have been described in previous publications \cite{Heiervang2007, Lundervold2011}.\\
...
$2$, $3$, or $4$),
 and information about age, gender and academic achievement when they were about 16 years old - in total $2397$ participants, $54.4$\% girls. 
...
The outcome scores that were available to our study was $average\_grade \in [0, 6]$, the mean value of the grades during high-school 
(\textcolor{blue}{not the final exam?}), comprising all subjects except for physical education (gym). %Figure 1 illustrates results on all variables for all participants included in the present study.  
